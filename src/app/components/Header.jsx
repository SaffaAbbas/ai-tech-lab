  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white border-b border-gray-200 z-50">
      ...
      <div className="bg-indigo-400 text-white">
        <div className="max-w-5xl mx-auto px-6 py-1.5 flex items-center justify-between text-xs">
          <a href="mailto:info@techoriginators.com" className="flex items-center gap-1.5 hover:text-indigo-200 transition">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            info@techoriginators.com
          </a>
          <a href="tel:+1234567890" className="flex items-center gap-1.5 hover:text-indigo-200 transition">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
